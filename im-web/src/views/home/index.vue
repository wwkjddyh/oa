        ...
        <a class="dropdown-icon" title="主菜单">
          <el-dropdown trigger="click" @command="handleCommand">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item v-if="oaEnter == false" command="changePassword">修改密码</el-dropdown-item>
              <el-dropdown-item v-if="oaEnter == false" command="logout" divided>注销登录</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </a>
  ...
  beforeRouteEnter(to, from, next){
    ...
    if (paramstr) {
      ...
      login(userInfoObj.name, '123456')
          .then(response => {
            console.log('模拟登陆 ==== ',response.data);
